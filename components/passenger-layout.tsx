...
import { passengerNavItems } from "@/lib/navigation"
...
export default function PassengerLayout({ children }: PassengerLayoutProps) {
  ...
  const routes = passengerNavItems.map((route) => ({
    ...route,
                ...
                <div className="flex flex-col gap-6 py-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-xs sm:text-sm text-muted-foreground">john@example.com</div>
                    </div>
                  </div>
